...
impl SVGElement {
    fn new_inherited(
        ...
        SVGElement::new_inherited_with_state(ElementState::empty(), tag_name, prefix, document, creator)
    }
    ...
    pub(crate) fn new_inherited_with_state(
        ...
        SVGElement {
            element: Element::new_inherited_with_state(state, tag_name, ns!(svg), prefix, document, creator),
    ...
    pub(crate) fn new(
        ...
        Node::reflect_node_with_proto(
            Box::new(SVGElement::new_inherited(tag_name, prefix, document, creator)),
            document,
            proto,
            can_gc,
        )
