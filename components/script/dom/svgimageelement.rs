...
impl SVGImageElement {
    fn new_inherited(
        ...
        SVGImageElement {
            svggraphicselement: SVGGraphicsElement::new_inherited(local_name, prefix, document, creator),
        }
    }
    ...
    pub(crate) fn new(
        ...
        Node::reflect_node_with_proto(
            Box::new(SVGImageElement::new_inherited(local_name, prefix, document, creator)),
            document,
            proto,
            can_gc,
        )
